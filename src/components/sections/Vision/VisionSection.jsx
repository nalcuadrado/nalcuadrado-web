...
export const VisionSection = () => {
  return (
    <section id="vision" className="pt-36 md:pt-44 pb-28 md:pb-36 bg-transparent relative z-10 scroll-mt-24 md:scroll-mt-28 overflow-hidden">
      {/* Elementos gráficos decorativos estilo Neo-brutalista */}
      <svg 
        className="absolute top-16 right-6 md:right-16 animate-spin-slow opacity-50 w-16 h-16 md:w-24 md:h-24 pointer-events-none z-0" 
        viewBox="0 0 100 100" 
        fill="none" 
      ...
      <svg 
        className="absolute bottom-24 left-6 md:left-12 animate-float-1 opacity-50 w-12 h-12 md:w-16 md:h-16 pointer-events-none z-0" 
        viewBox="0 0 100 100" 
        fill="none" 
        xmlns="http://www.w3.org/2000/svg"
      >
      ...
      <div className="container mx-auto px-4 md:px-10 relative z-10">
        ...
        <AnimatedSection className="flex flex-col md:flex-row justify-between items-end mb-12 md:mb-14 gap-6 border-b border-white/10 pb-6">
          <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          ...
          <AnimatedSection 
            delay="0.1s" 
            className="bg-[#121212]/95 rounded-[3rem] p-10 md:p-14 border border-white/10 flex flex-col justify-between relative overflow-hidden group hover:border-[#CDFC8A]/50 transition-all duration-500 shadow-2xl backdrop-blur-xl"
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div className="w-14 h-14 rounded-2xl bg-[#022E21]/80 border border-white/10 flex items-center justify-center text-[#CDFC8A] shadow-md">
                  <Target size={28} />
                </div>
                <span className="text-xs uppercase tracking-widest px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-300 font-bold">
                  Propósito Tangible
                </span>
              </div>

              <h3 className="text-4xl md:text-5xl font-display text-white mb-6 font-bold tracking-tight">
            ...
            <div className="relative z-10 mt-8 pt-6 border-t border-white/10 flex items-center gap-3 text-xs uppercase tracking-widest text-[#CDFC8A] font-bold">
          ...
          >
            ...
            <div className="relative z-10">
              <div className="flex items-center justify-between mb-8">
                <div className="w-14 h-14 rounded-2xl bg-[#3C183C]/80 border border-white/10 flex items-center justify-center text-[#CDFC8A] shadow-md">
                  <Compass size={28} />
                </div>
                <span className="text-xs uppercase tracking-widest px-4 py-1.5 rounded-full bg-white/5 border border-white/10 text-gray-300 font-bold">
                  Hacia el Futuro
        ...
        <AnimatedSection delay="0.3s" className="mt-8">
          <div className="flex items-center gap-6 mb-12">
            <div className="h-[1px] flex-1 bg-gradient-to-r from-transparent via-white/20 to-transparent"></div>
            <div className="flex items-center gap-3">
              <svg className="w-5 h-5 animate-spin-slow" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 0L57 35L93 15L65 43L100 50L65 57L93 85L57 65L50 100L43 65L7 85L35 57L0 50L35 43L7 15L43 35L50 0Z" fill="#CDFC8A"/>
              </svg>
              <h3 className="text-2xl font-display text-white tracking-widest text-center">
                el diferenciador n²
              </h3>
              <svg className="w-5 h-5 animate-spin-slow" viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M50 0L57 35L93 15L65 43L100 50L65 57L93 85L57 65L50 100L43 65L7 85L35 57L0 50L35 43L7 15L43 35L50 0Z" fill="#CDFC8A"/>
