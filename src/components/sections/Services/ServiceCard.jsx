  ...
  return (
    <div className="bg-[#121212]/95 rounded-3xl sm:rounded-[2.5rem] p-6 sm:p-10 border border-white/10 hover:border-[#CDFC8A]/50 transition-all duration-300 group relative overflow-hidden hover:-translate-y-2 cursor-pointer shadow-2xl backdrop-blur-xl">
      ...
      <div className="relative z-10">
        <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-2xl sm:rounded-[1.5rem] border ${iconBoxStyles} flex items-center justify-center mb-6 sm:mb-8 transition-colors duration-300 shadow-md`}>
          {item.icon}
        </div>
        
        {/* Título de alto contraste en blanco puro */}
        <h3 className="text-2xl sm:text-3xl text-white mb-3 sm:mb-4 font-display font-bold tracking-tight">
          {item.title}
        </h3>
